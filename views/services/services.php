...
// en mettant ../../Database/service_db.php les premiers .. me permet de sortir du dossier services 
...
<main class="flex-shrink-0">
    <div class="container">
        ...
        <a type="button" class="float-end mb-2 btn btn-primary" href="add_service.php">
            Nouveau
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-bs-toggle="modal" data-bs-target="#deleteServiceModal<?= $service->id ?>"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="deleteServiceModalLabel">Suppression servise
                                    <?= $service->libelle ?></h1>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/actions/services/deleteServiceAction.php?id=<?= $service->id ?>" type="button"
